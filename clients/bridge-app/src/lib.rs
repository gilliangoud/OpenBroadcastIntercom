...
const STYLE_CSS: &str = r#":root{font-family:Inter,ui-sans-serif,system-ui,-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif;color:#17202b;background:#f4f6f8;--line:#d7dee7;--line-strong:#b8c3d0;--muted:#637083;--brand:#c4212d;--brand-dark:#7f1019;--green:#137a45;--red:#b42318}
body{margin:0}.topbar{position:sticky;top:0;z-index:5;display:flex;align-items:center;justify-content:space-between;gap:16px;background:#17202b;color:#fff;padding:13px 18px}.topbar div:first-child{display:grid;gap:2px}.topbar strong{font-weight:900}.topbar span{color:#ced6e0;font-size:12px}
...
.actions{display:flex;gap:8px;align-items:center;flex-wrap:wrap}button{border:1px solid var(--line-strong);background:#fff;border-radius:6px;padding:7px 10px;cursor:pointer;color:#17202b}button.primary{background:var(--brand);border-color:var(--brand);color:#fff}button.danger{border-color:#f2b8b5;color:var(--red)}
