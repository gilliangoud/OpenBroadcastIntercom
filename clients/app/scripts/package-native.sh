...
echo "Building Intercom Suite native release binary..."
cargo build --features native --bin app-native --release

if cargo tauri --version >/dev/null 2>&1; then
  echo "Building Tauri bundles with clients/app/tauri.conf.json..."
